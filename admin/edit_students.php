...
<head>
    ...
    <title>STUDENTS RECODR OF IU CSE</title>
...
<body class="bg-light add_student">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
              <a class="navbar-brand text-primary" href="index.php"><i class="fas fa-tachometer-alt"></i> IU </a>
    ...
    <div class="container">
        ...
        <p class="text-center">2006-<?= date('Y')?> All Right Reserved. ISLAMIC UNIVERSITY CSE</p>
    </div>
