...
<head>
    ...
    <title>ISLAMIC UNIVERSITY CSE</title>
...
<body class="bg-light add_student">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
              <a class="navbar-brand text-primary" href="index.php"><i class="fas fa-tachometer-alt"></i> IU Dashboard</a>
    ...
    <div class="container">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mt-2">
                                <select name="department" class="form-control form-control-lg" required>
                                    ...
                                    <option value="Computer">Applied Chemistry</option>
                                    <option value="Computer">Information Technology</option>
                                    <option value="Computer">Biotechnology and Genetics</option>
                                </select>
                            </div>
                            <div class="mt-2">
        ...
        <p class="text-center">2024-<?= date('Y')?> Dept of CSE, IU</p>
    </div>
